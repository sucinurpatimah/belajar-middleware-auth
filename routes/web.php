...
//Dashboard
// Route::get('/dashboard/products', [DashboardController::class, 'products'])->name('dashboard.products')->middleware('authentication', 'role:superadmin|user');
// Route::get('/dashboard/users', [DashboardController::class, 'users'])->name('dashboard.users')->middleware('authentication', 'role:superadmin');
