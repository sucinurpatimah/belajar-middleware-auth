        ...
        <div class="row bg-info rounded px-3 py-3 w-100">
            <div class="d-flex justify-content-between">
                ...
                <div class="d-flex justify-content-end">
                    <a href="{{ route('dashboard.users.add') }}" class="btn btn-md btn-dark fw-bold my-auto me-1">Tambah
                        User</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            @if ($user->gender == 'male')
                                <td class="text-center">
                                    <div class="rounded px-3 py-1 bg-success w-50 mx-auto">{{ $user->gender }}</div>
                                </td>
                            @else
                                <td class="text-center">
                                    <div class="rounded px-3 py-1 bg-dark text-white w-50 mx-auto">{{ $user->gender }}</div>
                                </td>
                            @endif
